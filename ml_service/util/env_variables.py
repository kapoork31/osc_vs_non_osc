...
class Env:
    ...
    no_of_epochs: Optional[int] = os.environ.get("TRAINING_EPOCHS")
    batch_size: Optional[int] = os.environ.get("TRAINING_BATCH_SIZE")
    autoencoder_no_of_epochs: Optional[int] = os.environ.get(
        "AUTOENCODER_EPOCHS")
    autoencoder_batch_size: Optional[int] = os.environ.get(
